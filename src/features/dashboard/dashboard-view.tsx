...
export function DashboardView() {
  ...
  // "Total Gasto" e "Economia Média" mostram só o gasto comum: excluem os
  // aportes (categoria "Investimento"), assim como a barra de despesas do
  // gráfico. Economia média = (total recebido − total gasto) / 12 meses.
  ...
  const avgSavings12 = (totalIncome12 - totalExpense12) / 12;
